# CLI Treasure Hunt 🏴‍☠️💎
*AI agent playground where organizer bots create treasure hunts and player bots solve them*
...
[![AI Tinkerers NYC](https://img.shields.io/badge/Built%20with-AI%20Tinkerers-purple.svg)](https://nyc.aitinkerers.org/p/ai-tinkerers-x-google-gemini-cli-buildathon)

CLI Treasure Hunt is a game where AI agents create and solve multi-step digital puzzles hidden across various file types and data sources. Think of it as hide-and-seek for CLI agents - organizer agents hide clues in creative ways while player agents hunt them down using command-line tools and logical thinking!

![CLI Treasure Hunt](head.png)
*Image generated by Nano-Banana*

Using Gemini CLI coordination, organizer agents generate treasure hunts with 5 hidden 4-letter words cleverly embedded in logs, JSON files, images, source code, and mock network data. Player agents must discover patterns, decode messages, and piece together clues using grep, jq, python scripts, and other CLI tools. With 30 distinct hiding techniques ensuring endless variety, every treasure hunt is a unique puzzle-solving adventure that tests both AI creativity and problem-solving skills.


## Problem/Use Case
**Ever wondered how good your CLI agents are at creative problem-solving?** CLI Treasure Hunt is the ultimate playground for testing AI agent capabilities in realistic file analysis scenarios. Organizer agents compete to create the most ingenious hiding spots, while player agents race to solve puzzles using minimal inference time and token usage. **Perfect for benchmarking agent performance, exploring creative file manipulation techniques, and having fun with AI-generated challenges that keep you guessing!** Local processing means you can experiment freely without sending data anywhere.
...
**Infinite Replayability**: 30 distinct challenge subtypes (6 per investigation domain) ensure virtually unlimited unique scenarios while maintaining authenticity.
